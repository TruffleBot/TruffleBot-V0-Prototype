...
def make_model(params):
    ...
    #ADDED DROPOUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    lstm_layer = LSTM(2048, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'])(cnn_layer)
    lstm_layer2 = LSTM(768, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'])(lstm_layer)
    lstm_layer3 = LSTM(384, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'])(lstm_layer2)

    predictions = TimeDistributed(Dense(NUM_OUTPUTS, activation='sigmoid', dtype=tf.float32))(lstm_layer3)
