...
#WEIGHT_FILE = 'gs://uswow/models/resnetv2_ADAM_corrected/weights.tf'
#WEIGHT_FILE = 'gs://uswow/models/v6_wn/weights.tf'




WEIGHT_FILE = 'gs://uswow/models/v6_megaseq_predictFUTURE_60/weights.tf'
SAVE_FILE = 'gs://uswow/models/v6_megaseq_predictFUTURE_70/weights.tf'
setparam={
    'stateful':False,
    'train_cnn': True,
    'dropout':0.2,
...
def make_model(params):
    ...
    #ADDED DROPOUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    lstm_layer = LSTM(1024, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'], recurrent_dropout=params['dropout'])(cnn_layer)
    lstm_layer2 = LSTM(256, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'], recurrent_dropout=params['dropout'])(lstm_layer)
