...
SEQUENCE_LENGTH = 224//2
PER_CORE_BATCH_SIZE = 2

WEIGHT_FILE = 'gs://uswow/models/vAS_future_dropout_45/weights.tf'
SAVE_FILE = 'gs://uswow/models/vAS_future_dropout_60/weights.tf'
...
if USE_TPU:
    resolver = tf.distribute.cluster_resolver.TPUClusterResolver(tpu='node-6', project='openset-ml', zone='us-central1-a')  
...
train_dataset, val_dataset, train_steps, val_steps = get_datasets(batch_size=BATCH_SIZE,sequence_length=SEQUENCE_LENGTH, rand_buffer=128)
...
def make_model(params):
    ...
    #ADDED DROPOUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    lstm_layer = LSTM(384, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'], recurrent_dropout=params['dropout'])(cnn_layer)

    lstm_layer2 = LSTM(384, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'], recurrent_dropout=params['dropout'])(lstm_layer)
    lstm_layer3 = LSTM(384, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'], recurrent_dropout=params['dropout'])(lstm_layer2)
