...
WEIGHT_FILE = 'C:/Users/miste/Desktop/NNWoW/v7_wts/v7_wn_30/weights.tf'
...
def make_model(params):
    ...
    lstm_layer = GRU(4096, return_sequences=True, stateful=params['stateful'], dropout=params['dropout'])(cnn_layer)

    fc_1 = TimeDistributed(Dense(512, activation='relu'))(lstm_layer)

    predictions = TimeDistributed(Dense(NUM_OUTPUTS, activation='softmax', dtype=tf.float32))(fc_1)
